				...
				<div class="row">
					<div class="col-lg-6">
						<form:form id="myForm" method="post"
							class="bs-example form-horizontal" commandName="approveSeniorCitizen">
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										${approveSeniorCitizen.firstName}  ${approveSeniorCitizen.lastName}  
									</div>
								</div>
